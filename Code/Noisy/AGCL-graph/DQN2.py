...
class DQN():
    ...
    def load_model(self):
        ...
        self.temp_net1 = Net(self.num_state, self.num_action)
        self.temp_net2 = Net(self.num_state, self.num_action)
        ...
        beta = 0.7 #The interpolation parameter    
        ...
        self.act_net.load_state_dict(dict_params2)
        print("loaded model")
        time.sleep(3)
