...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        action_value = 0.4*action_value1 + 0.6*action_value2       
        return action_value
...
class medium_net_1(nn.Module):
    ...
    def forward(self, x):
        ...
        z = F.relu(self.fc5(z))
        action_value2 = self.fc6(z)
        action_value = 0.5*action_value1 + 0.5*action_value2       
        return action_value
...
class big_net_1(nn.Module):
    ...
    def forward(self, x):
        ...
        action_value = 0.25*action_value1 + 0.24*action_value2 + 0.51*action_value3       
        return action_value
