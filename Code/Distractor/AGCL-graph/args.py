...
class Args:
    def __init__(self):
        ...
        # training
        self.parser.add_argument('--time_limit', type=int, default=150, metavar='N',
        ...
        self.parser.add_argument('--input_size', type=int, default=46, help='input_size')
        ...
        self.parser.add_argument('--seed', type=int, default=0, help='random seed (default: 543)')
