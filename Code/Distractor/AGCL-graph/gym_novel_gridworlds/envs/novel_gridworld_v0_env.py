...
class NovelGridworldV0Env(gym.Env):
    ...
    def __init__(self, map_width=None, map_height=None, items_id=None, items_quantity=None, initial_inventory = None, goal_env = None, is_final = False):
        ...
        self.items = ['wall', 'tree', 'rock', 'crafting_table', 'pogo_stick', 'random_obj']
        ...
        self.items_quantity = {'tree': 5, 'rock': 2, 'crafting_table': 1, 'pogo_stick': 0, 'random_obj':0}
        ...
        self.items_lidar = ['wall', 'crafting_table', 'tree', 'rock', 'random_obj']
